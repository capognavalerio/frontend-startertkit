...
Filter & sort magical layouts like masonry
...
Google maps utilities like MarkerCluster and RichMarker
...
AjaxChimp is a jQuery plugin that lets you ajaxify your mailchimp form. Use this if you hate the jarring transition to the mailchimp website upon submitting an email address to mailchimp.
...
Query plugin to style select elements

#### https://github.com/vestman/Select-or-Die
---
